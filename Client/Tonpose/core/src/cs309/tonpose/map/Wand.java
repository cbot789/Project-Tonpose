...
public class Wand extends Item {
    ...
    public void fire(float targetX, float targetY, Player user){
        ...
        tonpose.tonposeScreen.Map.addToMap(new Projectile(MathUtils.random(tonpose.tonposeScreen.Map.UIDmax), user.getX(), user.getY(), targetX, targetY, 20, speed,tonpose));
    }
}
